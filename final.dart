...
void main() {
  ...
  while (true) {
    ...
    if (eleccion != null && eleccion >= 1 && eleccion <= 17) {
      switch (eleccion) {
        case 1:
        ...
        case 15:
          ...
          break;
        case 16:
          var challenge16 = Challenge16();
          challenge16.run();
          break;
        case 17:
          var challenge17 = Challenge17();
          challenge17.run();
          break;
        default:
      ...
      print("Escoge otro challenge, $nombre, o escribe 'q' para salir.");
    } else {
      print(
          "Opción no válida. Por favor, ingrese un número entre 1 y 17, o 'q' o 'exit' para salir.");
    }
  }
}